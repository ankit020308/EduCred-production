          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200 border border-slate-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3.5 px-6 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 transition-all group font-bold text-sm text-slate-700 disabled:opacity-50"
              >
